"""バッチ27 対象20問を精密監査。選択肢＋絶対化ヒット＋解説を文字化け回避でファイル出力。
F1223型（絶対化語を外すと攪乱肢が正答化する崩壊）を見抜くため、正答・全選択肢・解説をまとめて確認する。
"""
import json
import re
...
IDS = ['F257', 'F325', 'F443', 'F450', 'F844', 'F966', 'F1021', 'F1133', 'F1161', 'F1170',
       'F1182', 'F1359', 'F1360', 'F1361', 'F1367', 'F1368', 'F1382', 'F1384', 'F1386', 'F1387']
...
Path('_work/audit_batch27_result.txt').write_text('\n'.join(out), encoding='utf-8')
print('wrote _work/audit_batch27_result.txt', len(IDS), 'problems')
